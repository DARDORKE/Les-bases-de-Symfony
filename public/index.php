...
// L'objectif de cet exercice est de mettre en place :
//
// un système de template en deux couches : template principal (parent) et template de page (enfant)
//
// un template listant les titres des articles avec un lien pour en voir le détail
//
// un template affichant le détail d'un article avec son contenu et un bouton "retour"
// vers la liste des articles (le détail de l'article devra être dans un template séparé)
//
// et d'afficher la date de création d'un article au format relatif, tel que "il y a une semaine"
//
// Vous pourrez vous aider des contrôleurs suivants :
